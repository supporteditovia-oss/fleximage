  ...
  return (
    <>
      ...
      {showResult &&
        ...
        hasResultMedia && (
          <div
            className="mx-auto flex min-h-[calc(100svh-10.5rem)] w-full max-w-[28rem] flex-col items-center justify-start gap-4 overflow-y-auto overflow-x-hidden px-0 pb-6 pt-1 animate-in fade-in duration-500 md:h-[calc(100dvh-12.5rem)] md:max-w-none md:justify-center md:gap-6 md:overflow-hidden md:px-4 md:py-4"
          >
