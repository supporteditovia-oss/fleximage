      ...
      cgv: {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              { text: "Formule Decouverte : 240 credits par cycle de facturation mensuel." },
              { text: "Formule Essentiel : 720 credits par cycle de facturation mensuel + 120 credits offerts." },
              { text: "Formule Ultimate : 1920 credits par cycle de facturation mensuel." },
      ...
      cgv: {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              { text: "Discovery plan: 240 credits per monthly billing cycle." },
              { text: "Essential plan: 720 credits per monthly billing cycle + 120 bonus credits." },
              { text: "Ultimate plan: 1920 credits per monthly billing cycle." },
      ...
      cgv: {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              { text: "Plan Descubrimiento: 240 creditos por ciclo de facturacion mensual." },
              { text: "Plan Esencial: 720 creditos por ciclo de facturacion mensual + 120 creditos de regalo." },
              { text: "Plan Ultimate: 1920 creditos por ciclo de facturacion mensual." },
      ...
      cgv: {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              { text: "Discovery-Tarif: 240 Credits pro monatlichem Abrechnungszyklus." },
              { text: "Essentiel-Tarif: 720 Credits pro monatlichem Abrechnungszyklus + 120 Bonus-Credits." },
              { text: "Ultimate-Tarif: 1920 Credits pro monatlichem Abrechnungszyklus." },
