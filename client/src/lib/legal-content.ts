      ...
      cgv: {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              { text: "Formule Decouverte : 220 credits par cycle de facturation mensuel." },
              { text: "Formule Essentiel : 750 credits par cycle de facturation mensuel + 150 credits offerts." },
              { text: "Formule Ultimate : 2000 credits par cycle de facturation mensuel." },
      ...
      cgv: {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              { text: "Discovery plan: 220 credits per monthly billing cycle." },
              { text: "Essential plan: 750 credits per monthly billing cycle + 150 bonus credits." },
              { text: "Ultimate plan: 2000 credits per monthly billing cycle." },
      ...
      cgv: {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              { text: "Plan Descubrimiento: 220 creditos por ciclo de facturacion mensual." },
              { text: "Plan Esencial: 750 creditos por ciclo de facturacion mensual + 150 creditos de regalo." },
              { text: "Plan Ultimate: 2000 creditos por ciclo de facturacion mensual." },
      ...
      cgv: {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              { text: "Discovery-Tarif: 220 Credits pro monatlichem Abrechnungszyklus." },
              { text: "Essentiel-Tarif: 750 Credits pro monatlichem Abrechnungszyklus + 150 Bonus-Credits." },
              { text: "Ultimate-Tarif: 2000 Credits pro monatlichem Abrechnungszyklus." },
