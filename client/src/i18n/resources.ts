export const resources = {
  ...
  es: {
    ...
    paywall: {
      ...
      currency: "EUR",
      perMonthShort: "/mes",
      modalTitle: "Desbloquea tu foto en HD",
      modalSubtitle: "Elige tu plan para revelar el resultado final.",
      previewReadyTitle: "Tu foto está lista",
      previewReadyHintPrompt:
        "Hemos preparado tu resultado según tu petición. Desbloquéalo en HD antes de que desaparezca.",
      previewReadyHint:
        "Desbloquea tu resultado en HD antes de que expire — si no, la imagen se borra.",
