export const resources = {
  fr: {
    ...
    paywall: {
      ...
      pricingTitle: "Ton LARP t'attend.",
      ...
      currency: "EUR",
      perMonthShort: "/mois",
      planBadges: { bestValue: "Meilleur choix", exclusive: "Exclusif" },
      planBonuses: { essentialBonus: "+1000 crédits offerts" },
      planFeatures: {
      ...
      benefits: {
        ...
        newTemplates: "Nouveautés LarpKing",
      ...
      plans: {
        ...
        essential: {
          ...
          price: "19,90 EUR",
          credits: "9500 cr\u00e9dits",
          priceLine: "8,90 EUR/mois - R\u00e9siliable \u00e0 tout moment",
          oldPrice: "24,90 EUR",
          creditsPerMonth: "9500 crédits / mois",
        ...
        ultimate: {
          ...
          oldPrice: "49,90 EUR",
          creditsPerMonth: "Crédits illimités / mois",
          note: "Pour les créateurs sans limites",
        },
      },
      monthlySent: "🔥 {{count}} LARPs envoyés récemment",
      socialProof: "847+ LARPs débloqués aujourd'hui",
    ...
    meta: {
      appName: "LarpKing",
      titles: {
        home: "LarpKing — Crée des LARPs ultra réalistes avec l'IA",
        login: "Connexion — LarpKing",
        register: "Inscription — LarpKing",
        generate: "Crée ton LARP — LarpKing",
        history: "Historique — LarpKing",
        settings: "Paramètres — LarpKing",
        admin: "Admin — LarpKing",
        adminUsers: "Utilisateurs — LarpKing",
        adminTemplates: "Mod\u00e8les ? LarpKing",
        adminLogs: "Logs — LarpKing",
        legal: "Mentions légales — LarpKing",
        cgu: "CGU — LarpKing",
        cgv: "CGV — LarpKing",
        privacy: "Politique de confidentialité — LarpKing",
      },
    },
  },
  en: {
    ...
    paywall: {
      ...
      currency: "EUR",
      perMonthShort: "/month",
      planBadges: { bestValue: "Best value", exclusive: "Exclusive" },
      planBonuses: { essentialBonus: "+1000 bonus credits" },
      planFeatures: {
      ...
      benefits: {
        ...
        newTemplates: "New LarpKing drops",
      ...
      plans: {
        ...
        essential: {
          ...
          oldPrice: "EUR 24.90",
          creditsPerMonth: "9500 credits / month",
        ...
        ultimate: {
          ...
          oldPrice: "EUR 49.90",
          creditsPerMonth: "Unlimited credits / month",
          note: "For creators without limits",
        },
      },
      monthlySent: "🔥 {{count}} LARPs sent recently",
      socialProof: "847+ LARPs unlocked today",
    ...
    meta: {
      appName: "LarpKing",
      titles: {
        home: "LarpKing — Create ultra-realistic AI LARPs",
        login: "Sign in — LarpKing",
        register: "Sign up — LarpKing",
        generate: "Create your LARP — LarpKing",
        history: "History — LarpKing",
        settings: "Settings — LarpKing",
        admin: "Admin — LarpKing",
        adminUsers: "Users — LarpKing",
        adminTemplates: "Templates — LarpKing",
        adminLogs: "Logs — LarpKing",
        legal: "Legal notice — LarpKing",
        cgu: "Terms — LarpKing",
        cgv: "Sales terms — LarpKing",
        privacy: "Privacy policy — LarpKing",
      },
    },
  },
  es: {
    ...
    paywall: {
      ...
      currency: "EUR",
      perMonthShort: "/mes",
      planBadges: { bestValue: "Mejor opci?n", exclusive: "Exclusivo" },
      planBonuses: { essentialBonus: "+1000 cr?ditos de regalo" },
      planFeatures: {
      ...
      benefits: {
        ...
        newTemplates: "Novedades LarpKing",
      ...
      socialProof: "847+ LARPs desbloqueados hoy",
    ...
    meta: {
      appName: "LarpKing",
      titles: {
        home: "LarpKing — Crea LARPs ultra realistas con IA",
        login: "Iniciar sesión — LarpKing",
        register: "Registrarse — LarpKing",
        generate: "Crea tu LARP — LarpKing",
        history: "Historial — LarpKing",
        settings: "Configuración — LarpKing",
        admin: "Admin — LarpKing",
        adminUsers: "Usuarios — LarpKing",
        adminTemplates: "Plantillas — LarpKing",
        adminLogs: "Logs — LarpKing",
        legal: "Aviso legal — LarpKing",
        cgu: "Términos — LarpKing",
        cgv: "Condiciones de venta — LarpKing",
        privacy: "Política de privacidad — LarpKing",
      },
    },
  },
  de: {
    ...
    paywall: {
      ...
      currency: "EUR",
      perMonthShort: "/Monat",
      planBadges: { bestValue: "Bester Wert", exclusive: "Exklusiv" },
      planBonuses: { essentialBonus: "+1000 Bonus-Credits" },
      planFeatures: {
      ...
      benefits: {
        ...
        newTemplates: "Neue LarpKing-Vorlagen",
      ...
      socialProof: "847+ LARPs heute freigeschaltet",
    ...
    meta: {
      appName: "LarpKing",
      titles: {
        home: "LarpKing — Erstelle ultra-realistische KI-LARPs",
        login: "Anmeldung — LarpKing",
        register: "Registrierung — LarpKing",
        generate: "Erstelle deinen LARP — LarpKing",
        history: "Verlauf — LarpKing",
        settings: "Einstellungen — LarpKing",
        admin: "Admin — LarpKing",
        adminUsers: "Benutzer — LarpKing",
        adminTemplates: "Vorlagen — LarpKing",
        adminLogs: "Logs — LarpKing",
        legal: "Impressum — LarpKing",
        cgu: "Nutzungsbedingungen — LarpKing",
        cgv: "Verkaufsbedingungen — LarpKing",
        privacy: "Datenschutzrichtlinie — LarpKing",
      },
    },
  },
} as const;
