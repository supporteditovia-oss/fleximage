export const resources = {
  fr: {
    ...
    settings: {
      ...
      faceScan: {
        readyTitle: "Scan visage prêt",
        readyDescription: "Ce scan peut être utilisé pour tes générations.",
        emptyTitle: "Aucun scan visage",
        emptyDescription: "Crée un scan pour générer avec ton visage.",
        previewAlt: "Aperçu du scan visage",
        create: "Créer un scan",
        createFaceScan: "Créer mon scan visage",
        scan: "Scanner",
        retake: "Refaire",
        delete: "Supprimer",
        loadError: "Impossible de charger l'aperçu du scan.",
        updatedTitle: "Scan mis à jour",
        updatedDescription: "Ton nouveau scan visage est prêt.",
        deletedTitle: "Scan supprimé",
        deletedDescription: "Ton scan visage a été supprimé.",
      },
      subscription: {
        title: "Abonnement",
        price: "8,90 EUR/mois",
  ...
  en: {
    ...
    settings: {
      ...
      faceScan: {
        readyTitle: "Face scan ready",
        readyDescription: "This scan can be used for your generations.",
        emptyTitle: "No face scan",
        emptyDescription: "Create a scan to generate with your face.",
        previewAlt: "Face scan preview",
        create: "Create scan",
        createFaceScan: "Create my face scan",
        scan: "Scan",
        retake: "Retake",
        delete: "Delete",
        loadError: "Unable to load the scan preview.",
        updatedTitle: "Scan updated",
        updatedDescription: "Your new face scan is ready.",
        deletedTitle: "Scan deleted",
        deletedDescription: "Your face scan has been deleted.",
      },
      subscription: {
        title: "Subscription",
  ...
  es: {
    ...
    settings: {
      ...
      faceScan: {
        readyTitle: "Escaneo facial listo",
        readyDescription: "Este escaneo puede usarse para tus generaciones.",
        emptyTitle: "Sin escaneo facial",
        emptyDescription: "Crea un escaneo para generar con tu rostro.",
        previewAlt: "Vista previa del escaneo facial",
        create: "Crear escaneo",
        createFaceScan: "Crear mi escaneo facial",
        scan: "Escanear",
        retake: "Rehacer",
        delete: "Eliminar",
        loadError: "No se pudo cargar la vista previa del escaneo.",
        updatedTitle: "Escaneo actualizado",
        updatedDescription: "Tu nuevo escaneo facial está listo.",
        deletedTitle: "Escaneo eliminado",
        deletedDescription: "Tu escaneo facial se ha eliminado.",
      },
      deleteDialog: {
  ...
  de: {
    ...
    settings: {
      ...
      faceScan: {
        readyTitle: "Gesichtsscan bereit",
        readyDescription: "Dieser Scan kann für deine Generierungen verwendet werden.",
        emptyTitle: "Kein Gesichtsscan",
        emptyDescription: "Erstelle einen Scan, um mit deinem Gesicht zu generieren.",
        previewAlt: "Vorschau des Gesichtsscans",
        create: "Scan erstellen",
        createFaceScan: "Meinen Gesichtsscan erstellen",
        scan: "Scannen",
        retake: "Neu scannen",
        delete: "Löschen",
        loadError: "Die Scan-Vorschau konnte nicht geladen werden.",
        updatedTitle: "Scan aktualisiert",
        updatedDescription: "Dein neuer Gesichtsscan ist bereit.",
        deletedTitle: "Scan gelöscht",
        deletedDescription: "Dein Gesichtsscan wurde gelöscht.",
      },
      deleteDialog: {
