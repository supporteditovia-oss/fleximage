export const resources = {
  fr: {
    ...
    meta: {
      appName: "LarpKing",
      titles: {
        home: "LarpKing — Crée des pranks personnalisés avec l'IA",
        login: "Connexion — LarpKing",
        register: "Inscription — LarpKing",
        generate: "Crée ton prank — LarpKing",
  ...
  en: {
    ...
    meta: {
      appName: "LarpKing",
      titles: {
        home: "LarpKing — Create custom AI pranks",
        login: "Sign in — LarpKing",
        register: "Sign up — LarpKing",
        generate: "Create your prank — LarpKing",
  ...
  es: {
    ...
    meta: {
      appName: "LarpKing",
      titles: {
        home: "LarpKing — Crea bromas personalizadas con IA",
        login: "Iniciar sesión — LarpKing",
        register: "Registrarse — LarpKing",
        generate: "Crea tu broma — LarpKing",
  ...
  de: {
    ...
    meta: {
      appName: "LarpKing",
      titles: {
        home: "LarpKing — Erstelle individuelle KI-Streiche",
        login: "Anmeldung — LarpKing",
        register: "Registrierung — LarpKing",
        generate: "Erstelle deinen Streich — LarpKing",
