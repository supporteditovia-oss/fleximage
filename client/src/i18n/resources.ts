export const resources = {
  fr: {
    ...
    paywall: {
      ...
      title: "Ton prank est prêt !",
      subtitle: "Ton image est prête... mais elle est verrouillée",
      benefits: {
        noWatermark: "Sans filigrane",
        instantResult: "Résultat instantané",
        allTemplates: "Accès à tous les templates",
      },
  ...
  en: {
    ...
    paywall: {
      ...
      title: "Your prank is ready!",
      subtitle: "Your image is ready... but it's locked",
      benefits: {
  ...
  es: {
    ...
    paywall: {
      ...
      title: "¡Tu broma está lista!",
      subtitle: "Tu imagen está lista... pero está bloqueada",
      benefits: {
        noWatermark: "Sin marca de agua",
        instantResult: "Resultado instantáneo",
        allTemplates: "Acceso a todas las plantillas",
      },
  ...
  de: {
    ...
    paywall: {
      ...
      title: "Dein Streich ist fertig!",
      subtitle: "Dein Bild ist fertig... aber es ist gesperrt",
      benefits: {
        noWatermark: "Ohne Wasserzeichen",
        instantResult: "Sofortiges Ergebnis",
        allTemplates: "Zugriff auf alle Vorlagen",
      },
