...
const plans: PlanDefinition[] = [
  {
    ...
    description:
      "Monthly subscription: 220 credits for AI lifestyle image and video generations on LarpKing.",
  ...
  },
  {
    ...
    description:
      "Monthly subscription: 750 credits per month plus 150 bonus credits for regular creators (images and video on LarpKing).",
  ...
  },
  {
    ...
    description:
      "Monthly subscription: 2,000 credits per month for high-volume AI lifestyle image and video creation on LarpKing.",
